<template>
	...
	<div class="coupon-rule-wraper" id="coupon-rule">
		...
		<div class="content" id="content" :class="{'constant-height': isShowRule}">
		...
		<div class="coupon-show-more" @click="showMore">
			...
			<div class="show-more-btn" id="show-more-btn" :class="{'flex-down': isShowRule, 'flex-up': !isShowRule}"><span>查看详情</span></div>
		</div>
	</div>
</template>
